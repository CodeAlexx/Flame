...
pub fn is_cudnn_norm_compatible(input: &Tensor, norm_type: &str) -> bool {
    ...
    // Current cuDNN norm shims are FP32 only. For BF16 tensors, use native kernels.
...
pub fn cudnn_rms_norm(input: &Tensor, weight: Option<&Tensor>, eps: f64) -> Result<Tensor> {
