//! Phase 5b mul on the TensorIterator pipeline. Mirrors `ops::add_iter`.
//!
//! Replaces `bf16_elementwise::mul_bf16` (flat + broadcast).
//!
//! PyTorch reference: `aten/src/ATen/native/cuda/BinaryMulKernel.cu`.
