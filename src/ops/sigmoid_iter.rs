//! Phase 6 sigmoid on the TensorIterator pipeline. Mirror of `silu_iter.rs`.
//!
//! Y = 1/(1 + exp(-X)). BF16 storage, f32 opmath (matching PyTorch).
//!
//! PyTorch reference: `at::native::sigmoid_kernel_cuda` in
