...
// Legacy LoRA module kept for reference; on hold until Phase 3.
...
impl LoRALayer {
    ...
    pub fn num_parameters(&self) -> usize {
        // Account for both down/up projection tensors and their gradients.
        2 * (self.lora_down.shape().elem_count() + self.lora_up.shape().elem_count())
    }
...
impl LoRACollection {
    ...
    pub fn add_layer(&mut self, name: &str, in_features: usize, out_features: usize) -> Result<()> {
