...
use flame_core::regularization::{Dropout, Dropout2d, L2Regularization, L1Regularization, WeightStandardization};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Percentage of zeros: {:.1}%", (zero_count as f32 / output_data.len() as f32) * 100.0);
    ...
    println!("Time for 100 dropout operations on 64x512 tensor: {:?}", elapsed);
